...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0x001e90ff,
	...
	private static final int ITEM_OFFSET = 50 / 5;
	...
	public int getCurrentValue()
	{
		...
		{
			return ((NumericWheelAdapter)adapter).getCurrentItem(currentItem);
		}
		return 0;
	}
	/**
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			if (valuePaint != null) {
			    ...
			    valuePaint.setTextSize(PixelUtil.sp2px(16, context));
			}
		}
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(PixelUtil.sp2px(20, context));
			valuePaint.setShadowLayer(0.1f, 0, 0.3f, 0xFFC0C0C0);
		}
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		itemsWidth += PixelUtil.dp2Pixel(ADDITIONAL_ITEMS_SPACE, context); // make it some more
	...
	private void drawCenterRect(Canvas canvas) {
		...
		int offset = getItemHeight() / 2+getItemHeight() / 3;
