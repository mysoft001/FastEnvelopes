...
//            }
            textView.setBackgroundResource(mBackgroundSelector);
        ...
        if(DataUtils.getVersionCode(mContext)>22)
        {
            textView.setTextColor(mContext.getResources().getColor(mTextColor,null));
        }
        else
        {
            textView.setTextColor(mContext.getResources().getColor(mTextColor));
        }
