...
public class TabPageIndicator extends LinearLayout implements PageIndicator {
	...
	private void addTab(int index, CharSequence text, int iconResId,
		...
		if (iconResId != 0) {
			...
			// 0);
//			if (iconResId == R.drawable.living_tab) {
//				tabView.setTopIcon(iconResId, 45, 45);
//			}
//			// else if (iconResId == R.drawable.rank_tab) {
//			// tabView.setTopIcon(iconResId, 22, 22);
//			// }
//			else {
				tabView.setTopIcon(iconResId, 22, 22);
			//}
		...
		LayoutParams lp = new LinearLayout.LayoutParams(0, MATCH_PARENT, 1);
		lp.gravity = Gravity.CENTER;
		// lp.topMargin=PixelUtil.dp2Pixel(3, context);
		// if(iconResId==R.drawable.living_tab)
		// {
		//
		// }
		// else
		// {
		// lp.topMargin=PixelUtil.dp2Pixel(11, context);
		// }
	...
	public class TabView extends LinearLayout {
		...
		public TabView(Context context) {
			...
			text.setPadding(0, (int) dp2Pixel(2, context), 0, 0);
			img = new ImageView(context);
			//img.setId(R.id.bottom_w_iv);
		...
		public void setTopIcon(int resourceId, int width, int height) {
			img.setLayoutParams(new LayoutParams(PixelUtil.dp2Pixel(width,
					context), PixelUtil.dp2Pixel(height, context)));
