 ...
 */
public class ViewCirclePageIndicator extends View {
    ...
    public ViewCirclePageIndicator(Context context) {
	this(context, null);
    }

    public ViewCirclePageIndicator(Context context, AttributeSet attrs) {
